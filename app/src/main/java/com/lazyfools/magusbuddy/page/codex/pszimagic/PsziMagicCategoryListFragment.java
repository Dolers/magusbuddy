...
public class PsziMagicCategoryListFragment extends SearchableRecycleViewFragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        _viewModel.getAllPsziMagicTypes().observe(fragment, new Observer<List<PsziMagicType>>() {
            @Override
    ...
    protected int onItemClickNavigateTo() {
        return R.id.action_psziMagicCategoryListFragment_to_psziMagicSingleFragment;
    }
}
