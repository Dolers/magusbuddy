...
public class FireMagicCategoryListFragment extends SearchableRecycleViewFragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        _viewModel.getAllFireMagicTypes().observe(fragment, new Observer<List<FireMagicType>>() {
            @Override
    ...
    protected int onItemClickNavigateTo() {
        return R.id.action_fireMagicCategoryListFragment_to_fireMagicSingleFragment;
    }
}
